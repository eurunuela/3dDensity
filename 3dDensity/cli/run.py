# -*- coding: utf-8 -*-
"""Parser for 3dDensity."""


import argparse

from 3dDensity import __version__
...
def _get_parser():
    ...
    optional.add_argument('-history', '--history',
                          dest='history',
                          action='store_true',
                          help='Update the file history to contain the 3dDensity command.',
                          default=False)
...
if __name__ == '__main__':
    raise RuntimeError('3dDensity/cli/run.py should not be run directly;\n'
                       'Please `pip install` 3dDensity and use the '
                       '`3dDensity` command')
